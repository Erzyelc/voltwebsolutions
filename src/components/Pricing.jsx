    ...
    <div className=" py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <p className="mt-2 text-4xl font-bold tracking-tight sm:text-5xl bg-gradient-to-r from-[#2563EB]  to-[#ECBE44] inline-block text-transparent bg-clip-text">
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              <a
                ...
                className={classNames(
                  tier.mostPopular
                    ? "bg-[#2563EB]  shadow-sm hover:bg-indigo-400 focus-visible:outline-[#2563EB]"
